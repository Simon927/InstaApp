...
//Key
#define kKey @"lul29t2viy281429lul29t2viy281429"


//URL of the domain where you have upload PHP files
#define URL_SERVER @"http://www.instavtec.com/"
...
//Title app
#define APP_TITLE @"instaVTEC"    //Name of the app (appears in the navigation's bar of the main view)
...
#define INDEX_OF_EXPLORE 1
#define INDEX_OF_FOLLOWING 0
...
//Type
#define TYPE_POSTS_ALL @"-1"
#define TYPE_POSTS_HASHTAG @"-2"
#define TYPE_POSTS_FOLLOWED @"-3"
...
#define SERVICE_REPORT_POST @"report_post"
