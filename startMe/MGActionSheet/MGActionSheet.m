...
@property (copy, nonatomic) ChoiceCallBack choiceCallBack;
...
- (void)showInView:(UIView *)view withChoiceCompletition:(ChoiceCallBack)callBack {
    _choiceCallBack = Block_copy(callBack);
    [actionSheet showInView:view];
}

- (void)showFromTabBar:(UITabBar*)view withChoiceCompletition:(ChoiceCallBack)callBack
{
    _choiceCallBack = Block_copy(callBack);
