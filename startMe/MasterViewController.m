...
@synthesize tb, scrollView, isShownKeyboard;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if ([DataManager getInstance].isLogIn == NO) {
...
//
//    if([strSystemVersion floatValue] < 7.0){
//        
...
//                
//                tb.frame = CGRectMake(tb.frame.origin.x, tb.frame.origin.y + 20, tb.frame.size.width, tb.frame.size.height);
//                btSignIn.frame = CGRectMake(btSignIn.frame.origin.x, btSignIn.frame.origin.y + 20, btSignIn.frame.size.width, btSignIn.frame.size.height);
//                btResetPass.frame = CGRectMake(btResetPass.frame.origin.x, btResetPass.frame.origin.y + 20, btResetPass.frame.size.width, btResetPass.frame.size.height);
//            }
//        }
//    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [textField setAttributedPlaceholder:[[[NSAttributedString alloc] initWithString:placeholder attributes:@{NSForegroundColorAttributeName: CUSTOM_PLACEHOLDERCOLOR}] autorelease]];
